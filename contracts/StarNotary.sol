...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(owner1 != owner2, "Both Stars cannot be owned by same address.");
        require(_tokenId1 != _tokenId2, "Both Stars cannot have same token.");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(owner != _to1, "You cannot transfer Star to yourself.");
